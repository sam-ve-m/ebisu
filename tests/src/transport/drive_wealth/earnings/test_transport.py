...
from tests.src.transport.drive_wealth.earnings.stub_transport import get_transactions_model_stub, get_transactions_stub
...
@pytest.mark.asyncio
@patch.object(DwEarningsTransport, "_DwEarningsTransport__get_transactions", return_value=get_transactions_stub)
@patch.object(DwEarningsTransport, "_DwEarningsTransport__build_earning_model", side_effect=[get_transactions_model_stub, {}])
