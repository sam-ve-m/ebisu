...
@patch.object(
    BankCodeRepository,
    "get_bank_code_from_database",
    return_value=[{"CD_BANCO": "070", "NM_BANCO": "BANCO REGIONAL DE BRASILIA"}],
)
...
@patch.object(
    BankCodeRepository,
    "get_all_bank_codes_from_database",
    return_value=bank_code_list_stub,
)
