...
from src.services.forex_exchange.proposal_simulation.service import (
...
@pytest.mark.asyncio
@patch(
    "src.services.forex_exchange.proposal_simulation.service.UserRepository.get_user_exchange_data",
...
@pytest.mark.asyncio
@patch(
    "src.domain.models.forex_exchange.customer_exchange_request_data.model.config",
    side_effect=stub_config_path_quotation,
)
@patch(
    "src.services.forex_exchange.proposal_simulation.service.ExchangeCompanyApi.request_as_client",
