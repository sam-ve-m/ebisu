...
# STUBS IMPORTS
from tests.src.services.earnings_from_client.stub_earnings import get_br_payable_earnings_stub, \
    get_br_record_date_earnings_stub, get_br_paid_earnings_stub, get_earnings_response_stub, stub_get_service_response
...
@pytest.mark.asyncio
@patch.object(EarningsFromClient, "get_earnings_client_br_account", return_value=stub_get_service_response)
