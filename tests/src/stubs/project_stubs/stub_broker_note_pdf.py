...
brokerage_note_dummy = {
    "pdf_link": "https://brokerage-note-and-bank-statement.s3.amazonaws.com/14/Region.BR/"
...
file_link_brokerage_dummy = (
    "https://brokerage-note-and-bank-statement.s3.amazonaws.com/109/?AWSAccessKeyId=5243792748DGHDJDH"
...
month_broker_notes_dirs_bmf_br = {
    "ResponseMetadata": {
        "RequestId": "XR6HMV9M30YVDS2Q",
        "HostId": "PXZYLrTWpywLF56MwUy2Y25uPx0MwvxMYCUBoFN05AqPH96TQuK9WCBtlwNz+RXoTCJjstWyoDs=",
        "HTTPStatusCode": 200,
        "HTTPHeaders": {
    ...
    "Contents": [
        {
            "Key": "14/BR/broker_note/2022/4/5.pdf",
            "LastModified": datetime(2022, 5, 2, 18, 25, 29, tzinfo=None),
            "ETag": '"ff275b543b941d1da1de55bbb5517681-1"',
            "Size": 37874,
    ...
    "Name": "brokerage-note-and-bank-statement",
    "Prefix": "14/BR/broker_note/2022/4/",
    "Delimiter": "/",
    "MaxKeys": 1000,
    "EncodingType": "url",
}
...
month_response_stub = [
    {
        "broker_note_link": "https://brokerage-note-and-bank-statement.s3.amazonaws.com/14/Region.BR/broker_note/2022/4/19.pdf?AWSAccessKeyId=AKIATZVFXI25USQWCS5O&Signature=U0fZ7EtnQr5c2HStRgLowD8H22w%3D&Expires=1651258518",
        "day": 5,
        "market": "bmf",
        "region": "BR",
    }
