...
from tests.src.repositories.earnings.repository_stub import earnings_model_stub, earnings_payable_stub, \
    earnings_paid_model_stub, earnings_paid_stub, earnings_record_date_model_stub, earnings_record_date_stub
...
@patch.object(EarningsBrRecord, "build_br_earning_model", return_value=earnings_model_stub)
...
@patch.object(EarningsBrRecord, "build_br_earning_model", return_value=earnings_paid_model_stub)
@patch.object(EarningsClientRepository, "get_data", side_effect=[earnings_paid_stub, {}])
@patch.object(EarningsBrRecord, "build_earnings_types_where_clause", return_value="")
...
@patch.object(EarningsBrRecord, "build_br_earning_model", return_value=earnings_record_date_model_stub)
@patch.object(EarningsClientRepository, "get_data", side_effect=[earnings_record_date_stub, {}])
@patch.object(EarningsBrRecord, "build_earnings_types_where_clause", return_value="")
