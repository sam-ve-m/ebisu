...
async def test_when_no_param_of_region_is_passed_then_return_exception(mock_get_service_response):
...
async def test_when_getting_balance_us_then_return_expected(mock_get_dw_balance):
