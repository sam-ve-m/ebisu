...
from api.repositories.earnings.repository import EarningsClientRepository
from api.services.earnings_from_client.strategies import earnings_client_region
