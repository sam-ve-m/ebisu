...
class AccountCloseStepsToResponse:
    @staticmethod
    def account_close_steps_response(accounts_close_steps: List[AccountCloseSteps]) -> AccountCloseStepsResponse:
        has_permission_to_close_account = True
        accounts_steps: List[AccountSteps] = []
        for account_close_steps in accounts_close_steps:
            has_permission_to_close_account = \
                has_permission_to_close_account and account_close_steps.has_permission_to_close_account()
